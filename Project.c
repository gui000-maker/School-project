...
int main(void) {
  ...
  do {
    ...
    case 2:
      ...
      printf(
          "\nEm caso de intoxicações, o recomend(&c)ado é identificar o agente "
          "causador da intoxicação e solicitar "
          "atend(&c)imento especializado. A pessoa, nesse momento, deve ser "
    ...
    case 3:
      ...
      printf(
          ...
          "coração e levar a vítima ao atend(&c)imento médico mais rápido. É "
